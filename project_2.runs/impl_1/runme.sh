...
HD_PWD='C:/Users/Jayanth MN/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bpsk1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bpsk1.tcl -notrace
